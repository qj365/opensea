...
const categories = [
    ...
    },
    {
        id: 1,
        title: 'Art',
        link: '/explore-collections?tab=art',
        icon: SvgLogo.ArtLogo,
    },
    {
        id: 2,
        title: 'Gamming',
        link: '/explore-collections?tab=gamming',
        icon: SvgLogo.CollectiblesLogo,
    },
    {
        id: 3,
        title: 'PFP',
        link: '/explore-collections?tab=pfp',
        icon: SvgLogo.DomainLogo,
    },
    {
        id: 4,
        title: 'Music',
        link: '/explore-collections?tab=music',
        icon: SvgLogo.MusicLogo,
    },
    {
        id: 5,
        title: 'Photography',
        link: '/explore-collections?tab=photography',
        icon: SvgLogo.PhotographyLogo,
    },
    {
        id: 6,
        title: 'Sports',
        link: '/explore-collections?tab=sport',
