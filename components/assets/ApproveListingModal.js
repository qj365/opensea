...
function ApproveListingModal({
    approveListingModalVisible,
    setApproveListingModalVisible,
    usdPrice,
    nft,
    isApproving,
    newPrice,
            ...
            <div className="bg-[#262b2f] w-[500px] rounded-[10px] overflow-hidden">
                <div className="flex justify-between items-center pt-8 pb-4 px-6 border-[1px] border-[#353840]">
                    ...
                    <MdClose
                        ...
                        onClick={() => {
                            setApproveListingModalVisible(false);
                    ...
                    <div className="flex flex-col text-right ">
                        ...
                        <p className="text-[#8a939b] text-sm font-normal">
                            {new Intl.NumberFormat('en-US', {
                                ...
                                newPrice * usdPrice[nft?.listing?.currency]
                            )}{' '}
                            USD
                        </p>
                    </div>
