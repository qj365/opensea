...
function CardVerticalSkeleton() {
    return (
        <div
            className={`group w-[256px] rounded-xl overflow-hidden relative animate-pulse`}
        >
            <div>
                ...
                <div className="z-10 px-4 py-3 bg-[#353840]">
                    <div className="w-[80%]">
                        {/* {nft.name} */}
                        <div className="h-2.5 rounded-full bg-gray-700 w-36 mb-2"></div>
                        {/* {nft.collectionNft.name} */}
                        <div className="h-2.5 rounded-full bg-gray-700 w-32"></div>
                    </div>
                    <div className="h-[42px] mt-3 w-[90%] truncate">
                        <div className="h-2.5 rounded-full bg-gray-700 w-24"></div>
                    </div>
                </div>
            </div>
        </div>
